...
class CreateUsersBooksListMaster extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_users_books_list_master', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_users_books_list_master');
    }
}
