...
class CreateCommonCodeMasterTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_common_code_master', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_common_code_master');
    }
}
